...
export class MarbleSolitaireComponent extends React.Component<MarbleSolitaireProps, MarbleSolitaireState> {
  ...
  render() {
    return (
      <div>
        <BoardView game={this.state.game} colors={this.colorMap} onPlay={this.onBoardUpdate.bind(this)} />
      </div>
    );
  }
